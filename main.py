...
class Management:
    def __init__(self, root):
        ...
        # Left Frame
        self.frame_1 = Frame(self.window, bg=cs.color_3)
        ...
        self.add_book = Button(
            self.frame_2,
            text="Add Book",
            font=(cs.font_1, 12),
            bd=2,
            command=self.AddNewBook,
            cursor="hand2",
            bg=cs.color_1,
            fg=cs.color_4,
        ).place(x=50, y=40, width=100)
        self.issue_book = Button(
            self.frame_2,
            text="Issue Book",
            font=(cs.font_1, 12),
            bd=2,
            command=self.GetData_for_IssueBook,
            cursor="hand2",
            bg=cs.color_7,
            fg=cs.color_3,
        ).place(x=50, y=100, width=100)
        self.return_book = Button(
            self.frame_2,
            text="Return Book",
            font=(cs.font_1, 12),
            bd=2,
            ...
            bg=cs.color_6,
            fg=cs.color_3,
        ).place(x=50, y=160, width=100)
        self.all_book = Button(
            self.frame_2,
            text="All Books",
            font=(cs.font_1, 12),
            bd=2,
        ...
        self.search_book = Button(
            ...
            font=(cs.font_1, 12),
            bd=2,
            command=self.GetBookNametoSearch,
            cursor="hand2",
            bg=cs.color_2,
            fg=cs.color_3,
        ).place(x=180, y=40, width=100)
        self.all_borrow_records = Button(
            self.frame_2,
            text="Book Holders",
            font=(cs.font_1, 12),
            bd=2,
            command=self.AllBorrowRecords,
            cursor="hand2",
            bg=cs.color_3,
            fg=cs.color_4,
        ).place(x=180, y=100, width=100)
        self.clear = Button(
            self.frame_2,
            text="Clear Screen",
            font=(cs.font_1, 12),
    ...
    def OnSelectedforReturn(self, a):
        self.dlt_record = Button(
            ...
            bg=cs.color_2,
            fg=cs.color_3,
        ).place(x=50, y=0, width=100)
        self.borrow_again = Button(
            self.frame_3,
            text="Issue Again",
            font=(cs.font_1, 12),
            bd=2,
            command=self.IssueAgain,
            cursor="hand2",
            bg=cs.color_2,
            fg=cs.color_3,
        ).place(x=180, y=0, width=100)
    ...
    def OnSelectedforShowBooks(self, a):
        ...
        self.update_record = Button(
            ...
            font=(cs.font_1, 12),
            bd=2,
            command=self.UpdateBookDetails,
            cursor="hand2",
            bg=cs.color_2,
            fg=cs.color_3,
        ).place(x=180, y=0, width=100)
            ...
            if status == True:
                ...
                if len(var) != 0:
                    messagebox.showwarning(
                        "Critical Warning!", "You can't delete this book record"
                    )
                else:
                    curs.execute("delete from book_list where book_id=%s", (row[0]))
    ...
    def ReturningBook(self):
        ...
        try:
            status = messagebox.askokcancel(
                "Returning Book", "Are you want to proceed?"
            )
            if status == True:
                connection = pymysql.connect(
                    host=cr.host,
                ...
                curs = connection.cursor()
                curs.execute("delete from borrow_record where book_id=%s", (row[0]))
                ...
                curs.execute(
                    "update book_list set qty=%s where book_id=%s", (book_count, row[0])
                )
    ...
    def IssueAgain(self):
        ...
        book_id = Label(
            self.frame_1, text="Book Id", font=(cs.font_2, 15, "bold"), bg=cs.color_1
        ).place(x=130, y=30)
        id = Label(self.frame_1, text=row[0], font=(cs.font_1, 10))
        id.place(x=130, y=60, width=200)

        book_name = Label(
            self.frame_1, text="Book Name", font=(cs.font_2, 15, "bold"), bg=cs.color_1
        ).place(x=400, y=30)
        ...
        course = Label(
            self.frame_1, text="Course", font=(cs.font_2, 15, "bold"), bg=cs.color_1
        ).place(x=130, y=170)
        Course = Label(self.frame_1, text=row[4], font=(cs.font_1, 10))
        Course.place(x=130, y=200, width=200)

        subject = Label(
            self.frame_1, text="Subject", font=(cs.font_2, 15, "bold"), bg=cs.color_1
        ).place(x=400, y=170)
        Subject = Label(self.frame_1, text=row[5], font=(cs.font_1, 10))
        Subject.place(x=400, y=200, width=200)

        issue_date = Label(
            self.frame_1, text="Issue Date", font=(cs.font_2, 15, "bold"), bg=cs.color_1
        ).place(x=130, y=240)
        ...
        self.return_date_entry = Entry(self.frame_1, bg=cs.color_3, fg=cs.color_4)
        ...
        self.submit_bt = Button(
            ...
            font=(cs.font_1, 12),
            bd=2,
            command=partial(self.BorrowBookAgain, row),
            cursor="hand2",
            bg=cs.color_2,
            fg=cs.color_3,
        ).place(x=300, y=320, width=100)
    ...
    def BorrowBookAgain(self, row):
        try:
            ...
            curs = connection.cursor()
            curs.execute(
                "update borrow_record set return_date=%s where stu_roll=%s and book_id=%s",
                (self.return_date_entry.get(), row[2], row[0]),
            )
    ...
    def ReturnBook(self):
        ...
        return_book = Label(
            self.frame_1,
            text="Return Book",
            font=(cs.font_1, 30, "bold"),
            bg=cs.color_4,
        ).place(x=250, y=40)
        roll_no = Label(
            self.frame_1,
            text="Enter the Roll No.",
            font=(cs.font_2, 15, "bold"),
            bg=cs.color_1,
        ).place(x=210, y=140)
        self.roll_no_entry = Entry(self.frame_1, bg=cs.color_3, fg=cs.color_4)
        self.roll_no_entry.place(x=210, y=175, width=300)

        self.search_bt = Button(
            self.frame_1,
            text="Search",
            font=(cs.font_1, 12),
            bd=2,
            command=self.ShowRecordsforReturn,
            cursor="hand2",
            bg=cs.color_2,
            fg=cs.color_3,
        ).place(x=310, y=215, width=100)
    ...
    def UpdateBookDetails(self):
        ...
        book_id = Label(
            self.frame_1, text="Book Id", font=(cs.font_2, 18, "bold"), bg=cs.color_1
        ).place(x=220, y=30)
        id = Label(self.frame_1, text=row[0], font=(cs.font_1, 10))
        ...
        self.bookname_entry = Entry(self.frame_1, bg=cs.color_3, fg=cs.color_4)
        self.bookname_entry.insert(0, row[1])
        self.bookname_entry.place(x=220, y=130, width=300)

        author = Label(
            self.frame_1, text="Author", font=(cs.font_2, 15, "bold"), bg=cs.color_1
        ).place(x=220, y=170)
        self.author_entry = Entry(self.frame_1, bg=cs.color_3, fg=cs.color_4)
        self.author_entry.insert(0, row[2])
        self.author_entry.place(x=220, y=200, width=300)

        edition = Label(
            self.frame_1, text="Edition", font=(cs.font_2, 15, "bold"), bg=cs.color_1
        ).place(x=220, y=240)
        self.edition_entry = Entry(self.frame_1, bg=cs.color_3, fg=cs.color_4)
        self.edition_entry.insert(0, row[3])
        self.edition_entry.place(x=220, y=270, width=300)

        price = Label(
            self.frame_1, text="Price", font=(cs.font_2, 15, "bold"), bg=cs.color_1
        ).place(x=220, y=310)
        self.price_entry = Entry(self.frame_1, bg=cs.color_3, fg=cs.color_4)
        self.price_entry.insert(0, row[4])
        self.price_entry.place(x=220, y=340, width=300)

        quantity = Label(
            self.frame_1, text="Quantity", font=(cs.font_2, 15, "bold"), bg=cs.color_1
        ).place(x=220, y=380)
        self.qty_entry = Entry(self.frame_1, bg=cs.color_3, fg=cs.color_4)
        self.qty_entry.insert(0, row[5])
        self.qty_entry.place(x=220, y=410, width=300)

        self.submit_bt_1 = Button(
            self.frame_1,
            text="Submit",
            font=(cs.font_1, 12),
            bd=2,
            command=partial(self.SubmitforUpdateBook, row),
            cursor="hand2",
            bg=cs.color_2,
            fg=cs.color_3,
        ).place(x=310, y=459, width=100)
    ...
    def SubmitforUpdateBook(self, row):
        try:
            ...
            curs = connection.cursor()
            curs.execute(
                "update book_list set book_name=%s,author=%s,edition=%s,price=%s,qty=%s where book_id=%s",
                (
    ...
    def GetData_for_IssueBook(self):
        ...
        self.book_id_entry = Entry(self.frame_1, bg=cs.color_3, fg=cs.color_4)
        self.book_id_entry.place(x=130, y=60, width=200)

        book_name = Label(
            self.frame_1, text="Book Name", font=(cs.font_2, 15, "bold"), bg=cs.color_1
        ).place(x=400, y=30)
        self.book_name_entry = Entry(self.frame_1, bg=cs.color_3, fg=cs.color_4)
        ...
        self.stu_roll_entry = Entry(self.frame_1, bg=cs.color_3, fg=cs.color_4)
        ...
        self.stu_name_entry = Entry(self.frame_1, bg=cs.color_3, fg=cs.color_4)
        self.stu_name_entry.place(x=400, y=130, width=200)

        course = Label(
            self.frame_1, text="Course", font=(cs.font_2, 15, "bold"), bg=cs.color_1
        ).place(x=130, y=170)
        self.course_entry = Entry(self.frame_1, bg=cs.color_3, fg=cs.color_4)
        self.course_entry.place(x=130, y=200, width=200)

        subject = Label(
            self.frame_1, text="Subject", font=(cs.font_2, 15, "bold"), bg=cs.color_1
        ).place(x=400, y=170)
        self.subject_entry = Entry(self.frame_1, bg=cs.color_3, fg=cs.color_4)
        self.subject_entry.place(x=400, y=200, width=200)

        issue_date = Label(
            self.frame_1, text="Issue Date", font=(cs.font_2, 15, "bold"), bg=cs.color_1
        ).place(x=130, y=240)
        self.issue_date_entry = Entry(self.frame_1, bg=cs.color_3, fg=cs.color_4)
        ...
        self.submit_bt_1 = Button(
            ...
            font=(cs.font_1, 12),
            bd=2,
            command=self.Submit_borrow_data,
            cursor="hand2",
            bg=cs.color_2,
            fg=cs.color_3,
        ).place(x=300, y=320, width=100)
    ...
    def GetBookNametoSearch(self):
        ...
        self.book_entry = Entry(self.frame_1, bg=cs.color_3, fg=cs.color_4)
    ...
    def ShowBooks(self):
        ...
        try:
            ...
            if rows == None:
                messagebox.showinfo(
                    "Database Empty", "There is no data to show", parent=self.window
                )
                connection.close()
                self.ClearScreen()
            else:
    ...
    def ShowRecordsforReturn(self):
        if self.roll_no_entry.get() == "":
            ...
            try:
                ...
                curs = connection.cursor()
                curs.execute(
                    "select * from borrow_record where stu_roll=%s",
                ...
                if len(rows) == 0:
                    messagebox.showerror(
                        "Error!", "This roll no. doesn't exists", parent=self.window
                    )
                    connection.close()
    ...
    def SearchBook(self):
        if self.book_entry.get() == "":
            ...
            try:
                ...
                curs = connection.cursor()
                curs.execute(
                    "select * from book_list where book_name like %s",
                    ("%" + self.book_entry.get() + "%"),
                )
                rows = curs.fetchall()
                if rows == None:
    ...
    def AddNewBook(self):
        ...
        self.id_entry = Entry(self.frame_1, bg=cs.color_3, fg=cs.color_4)
    ...
    # Function 20: This function adds a new book record'''
    def Submit(self):
        if (
            self.id_entry.get() == ""
            or self.bookname_entry.get() == ""
            or self.author_entry.get() == ""
            or self.edition_entry.get() == ""
            or self.price_entry.get() == ""
            or self.qty_entry.get() == ""
        ):
            messagebox.showerror(
            ...
            try:
                ...
                curs = connection.cursor()
                curs.execute(
                    "select * from book_list where book_id=%s", self.id_entry.get()
                )
                row = curs.fetchone()
                ...
                if row != None:
                    messagebox.showerror(
                        "Error!",
                        "This book id is already exists, please try again with another one",
                        parent=self.window,
                    )
                else:
                    curs.execute(
    ...
    def Submit_borrow_data(self):
        if (
            ...
            or self.book_name_entry.get() == ""
            or self.stu_roll_entry.get() == ""
            or self.stu_name_entry.get() == ""
            or self.issue_date_entry.get() == ""
            or self.return_date_entry.get == ""
            or self.course_entry.get() == ""
            or self.subject_entry.get() == ""
        ):
            messagebox.showerror(
                "Error!", "Sorry!, All fields are required", parent=self.window
            )
            ...
            try:
                ...
                curs = connection.cursor()
                curs.execute(
                    "select * from book_list where book_id=%s", self.book_id_entry.get()
                )
                row = curs.fetchone()
                book_quantity = row[5]
                if row == None:
                    messagebox.showerror(
                        "Error!", "This book isn't exist", parent=self.window
                    )
                elif book_quantity == 1:
                    messagebox.showwarning(
                        "Notification", "This copy is left only one, you can't take it"
                    )
                else:
                    curs.execute(
                        "select * from borrow_record where stu_roll=%s and book_id=%s",
                        (self.stu_roll_entry.get(), self.book_id_entry.get()),
                    )
                    row = curs.fetchone()
                    if row != None:
                        messagebox.showerror(
                            "Error!", "This book is already taken by the student"
                        )
                        connection.close()
                    else:
                        curs.execute(
                        ...
                        if len(rows) >= 3:
                            messagebox.showerror(
                                "Max. 3 books to each student",
                                "Borrow books limit has exceed",
                            )
                            connection.close()
                        else:
                            curs.execute(
                            ...
                            book_quantity -= 1
                            curs.execute(
                                "update book_list set qty=%s where book_id=%s",
